...
export class SiparislerComponent implements OnInit {
  ...
  Duzenle(kayit: Siparis) {
    ...
    this.dialogRef.afterClosed().subscribe((d) => {
      if (d) {
        ...
        kayit.siparisUrunId = d.siparisUrunId;
  ...
  Sil(kayit: Siparis) {
    ...
    this.confirmdialogRef.componentInstance.dialogMesaj = kayit.siparisKodu + " Kodlu " + kayit.siparisUrunAdi + '  Ürünün Siparişi Silinecektir Onaylıyor Musunuz?';
